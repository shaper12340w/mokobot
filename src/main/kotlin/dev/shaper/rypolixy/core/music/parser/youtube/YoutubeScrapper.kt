package dev.shaper.rypolixy.core.music.parser.youtube
...
object YoutubeScrapper {
    ...
    suspend fun getRelatedData(videoId: String,count:Int = 10): List<dev.shaper.rypolixy.core.music.parser.youtube.YoutubeParseInfo.CompactVideoInfo>? {
        try {
